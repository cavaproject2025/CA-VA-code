...
PDF_DIRECTORY = "./Tripartite Guidelines"
WORD_DIRECTORY = "./wst"
WEB_URLS = [
...
def load_all_documents() -> List:
    ...
    all_documents = pdf_docs + word_docs + web_docs
...
def setup_qa_system(vectorstore: Chroma, llm: AzureChatOpenAI):
    ...
    def search_collective_agreements(query: str) -> str:
        """
        Search collective agreements, employment practices, and MOM guidelines for information.
...
def create_gradio_interface():
    ...
    with gr.Blocks(title="Collective Agreement Virtual Assistant") as app:
        ...
        - Tripartite guidelines, WST documents, and MOM resources
        ...
        **Smart Tools:** The assistant automatically decides whether to search collective agreements or fetch current salary data based on your question.
        ...
        with gr.Row():
            with gr.Column(scale=1):
                ...
                question_input = gr.Textbox(
                    label="Your Question",
                    placeholder="e.g., What are the salary ranges for Lab Technicians? or What should companies do during retrenchment?",
                    lines=3
                )
                ...
                gr.Markdown("**AI Tools:** Ask about salaries to get MyCareersFuture data, or employment practices for CA information.")
        ...
        gr.Examples(
            examples=[
                ["What are the salary ranges for Lab Technicians?"],
                ["What are the current market rates for Data Analysts?"],
                ...
                ["What are the guidelines for flexible work arrangements?"],
                ["How should employers handle workplace disputes?"]
            ],
...
def get_salary_from_mycareersfuture(job_role: str) -> str:
    ...
    Args:
        job_role: The job title to search for (e.g., 'Data Scientist', 'Lab Technician', 'Software Engineer')
