...
def create_gradio_interface():
    ...
    with gr.Blocks(title="Collective Agreement Virtual Assistant") as app:
        ...
        **Smart Tools:** The assistant automatically decides whether to search collective agreements or fetch current salary data based on your question.
        ...
        gr.Examples(
            examples=[
                ["What are the CA salary ranges for Housekeepers across Hotels CA?"],
                ["What are the CA salary ranges for Technicians across Food Manufacturing CA?"],
                ...
                ["What are the market salaries for Operators in food manufacturing companies on MyCareersFuture?"],
                ["What are the market salaries for Demi Chef in hotels on MyCareersFuture ?"],
